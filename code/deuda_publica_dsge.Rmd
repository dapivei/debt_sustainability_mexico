...
df<-read.xlsx('/Users/danielapintoveizaga/INSTITUTO TECNOLOGICO AUTONOMO DE MEXICO/FIDEL GONZALEZ PARRA - Trabajo Macro/Scatterplot.xlsx',
          sheet = 7)
```
...
het<-read.xlsx('/Users/danielapintoveizaga/INSTITUTO TECNOLOGICO AUTONOMO DE MEXICO/FIDEL GONZALEZ PARRA - Trabajo Macro/Scatterplot.xlsx',
          sheet = 8)
het_melt<-melt(het)
```
...
```{r}
mexico_data<-read.xlsx('/Users/danielapintoveizaga/INSTITUTO TECNOLOGICO AUTONOMO DE MEXICO/FIDEL GONZALEZ PARRA - Trabajo Macro/Scatterplot.xlsx',
          sheet = 1
          )
```
